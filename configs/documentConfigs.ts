...
### 13. DISPOSIÇÕES GERAIS
  ...
  [DocumentType.PESQUISA_PRECO]: {
    extractionSchema: {
      objeto:            'Objeto a ser pesquisado',
      especificacao:     'Especificação técnica detalhada do item',
      quantidade:        'Quantidade para fins de pesquisa',
      unidade_medida:    'Unidade de medida',
      secretaria:        'Secretaria solicitante',
      responsavel:       'Responsável pela pesquisa',
    },
    requiredFields: ['objeto', 'especificacao'],
    checklist: [
      { field: 'fontes_consultadas', rule: 'not_blank',       weight: 30, description: 'Mínimo 3 fontes consultadas' },
      { field: 'tabela_precos',      rule: 'has_table',       weight: 30, description: 'Tabela com preços coletados' },
      { field: 'metodologia',        rule: 'min_words_50',    weight: 20, description: 'Metodologia de cálculo explicada' },
      { field: 'valor_referencia',   rule: 'positive_number', weight: 20, description: 'Valor de referência calculado' },
    ],
...
## CONTEXTO DE MERCADO DISPONÍVEL:
${market}

## MISSÃO:
Elabore um Relatório Analítico de Pesquisa de Preços conforme art. 23 da
Lei 14.133/2021 e IN SEGES/ME nº 65/2021.

## REGRAS CRÍTICAS:
- Use APENAS preços que possam ser referenciados — NUNCA invente valores
- Se não houver dados de mercado suficientes: indique "pesquisa pendente — necessário
  coletar cotações formais conforme art. 5º da IN SEGES/ME 65/2021"
- Metodologia obrigatória: média aritmética com expurgo de outliers acima de 1,5× desvio padrão
- Validade da pesquisa: 180 dias a partir da data de elaboração

## ESTRUTURA OBRIGATÓRIA:

### IDENTIFICAÇÃO DO OBJETO E DA PESQUISA

### METODOLOGIA ADOTADA
[Fontes consultadas em ordem de prioridade — art. 5º IN 65/2021:
 1. Painel de Preços gov.br | 2. PNCP | 3. Atas de RP vigentes | 4. Contratos | 5. Fornecedores | 6. Mídia]

### QUADRO DE RESULTADOS DA PESQUISA
| Item | Especificação | Preço Unit. (R$) | Órgão/Fonte | Data | URL/Referência |
[Preencher com dados reais disponíveis ou "A COLETAR" para itens pendentes]

### ANÁLISE ESTATÍSTICA E EXPURGO DE OUTLIERS
[Calcular: média, mediana, desvio padrão, coeficiente de variação]

### PREÇO DE REFERÊNCIA CONSOLIDADO
[Valor unitário e total — fundamentado na metodologia]

### CONCLUSÃO E VIGÊNCIA DA PESQUISA
[Data de validade — 180 dias]
