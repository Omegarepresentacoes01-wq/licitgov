...
export const LoginPage: React.FC<LoginPageProps> = ({ onLoginSuccess }) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-navy-900 relative overflow-hidden font-sans">
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-br from-navy-800 via-navy-900 to-navy-950 z-0" />

      {/* Decorative orbs */}
      <div className="absolute top-[-10%] right-[-5%] w-[600px] h-[600px] bg-primary-500/10 rounded-full blur-[100px] pointer-events-none z-0" />
      <div className="absolute bottom-[-10%] left-[-10%] w-[500px] h-[500px] bg-primary-800/10 rounded-full blur-[120px] pointer-events-none z-0" />
      ...
      <div className="max-w-7xl w-full mx-auto grid lg:grid-cols-12 gap-16 p-6 relative z-10 items-center">
        ...
        <div className="lg:col-span-7 text-white space-y-8 animate-fadeIn">
          <div className="flex items-center gap-3">
            <h2 className="text-3xl font-extrabold tracking-tight text-white">LicitGov AI</h2>
          ...
          <div className="pt-4 flex flex-wrap items-center gap-4">
            <button className="bg-primary-600 hover:bg-primary-500 text-white font-bold py-3.5 px-8 rounded-lg transition-all transform hover:-translate-y-0.5 shadow-lg shadow-primary-600/30">
              Solicitar Orçamento
            </button>
          ...
          <div className="pt-8 flex items-center gap-4 text-sm text-slate-400 font-medium">
            <div className="flex -space-x-3">
              ...
              <div className="w-8 h-8 rounded-full bg-slate-500 border-2 border-navy-900" />
            </div>
          ...
          <div className="bg-navy-800/80 backdrop-blur-xl p-8 lg:p-10 rounded-3xl border border-white/10 shadow-2xl">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                disabled={loading}
                className={`w-full flex justify-center py-4 px-4 text-base font-bold rounded-xl text-white bg-primary-600 hover:bg-primary-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-navy-900 focus:ring-primary-500 transition-all shadow-lg shadow-primary-600/20
